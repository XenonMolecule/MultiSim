...
def main():
    ...
    raw_datasets = load_dataset("./MultilingualSimplification.py", name=args.dataset_name)
    ...
    for step, batch in enumerate(eval_dataloader):
        ...
        data = raw_datasets['test'][step*args.per_device_eval_batch_size : (step+1)*args.per_device_eval_batch_size]
